    ...
    <div class="shell">
        <div class="range">
            <div class="cell-md-10 cell-lg-8">
                ...
                <h5>Edit profile</h5>
                <hr>
                <form:form data-form-output="form-output-global" data-form-type="contact" method="post" action="profile"
                    modelAttribute="profileForm">
                    <div class="range">
                        <div class="cell-sm-6">
                            <div class="form-group offset-top-18">
                                <label for="first_name" class="form-label-outside"></label>
                                <form:input path="first_name" value="${currentUser.firstName}" type="text"
                                    name="first-name" data-constraints="@Required" class="form-control" />
                        ...
                        <div class="cell-sm-6 offset-top-18 offset-sm-top-0">
                            <div class="form-group offset-top-18">
                                ...
                                <form:input path="last_name" value="${currentUser.lastName}" type="text"
                                    name="last-name" data-constraints="@Required" class="form-control" />
                        ...
                        <div class="cell-sm-6 offset-top-18">
                            <div class="form-group offset-top-18">
                                ...
                                <form:input path="login" value="${currentUser.login}" type="text" name="login"
